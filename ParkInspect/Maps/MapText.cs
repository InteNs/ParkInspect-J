...
{
    class MapText : FrameworkElement
    {
        ...
        public static readonly DependencyProperty TextProperty = TextBlock.TextProperty.AddOwner(
            typeof(MapText), new FrameworkPropertyMetadata((o, e) => ((MapText)o).glyphRun = null));
        ...
        public static readonly DependencyProperty BackgroundProperty = TextBlock.BackgroundProperty.AddOwner(
            typeof(MapText), new FrameworkPropertyMetadata(Brushes.White, (o, e) => ((MapText)o).glyphRun = null));
        ...
        public static readonly DependencyProperty OutlineThicknessProperty = DependencyProperty.Register(
            ...
            new FrameworkPropertyMetadata(1d, FrameworkPropertyMetadataOptions.AffectsMeasure, (o, e) => ((MapText)o).glyphRun = null));
